...
class testGeneralReportAnnouncement(LiveServerTestCase):
    ...
    def enterAnnouncementScreen(self):
        
        appBtn = self.driver.find_element(by=By.ID,value='ann_btn')
        appBtn.click()
    ...
    def enterSumScreen(self):
        ...
        allBtn = self.driver.find_element(by=By.ID,value='all_btn')
        allBtn.click()
        
        assert '/reportResume/' in self.driver.current_url
    

    def testGeneralReportAnnouncement(self):

        self.logIn()
        self.enterReportScreen()
        self.enterAnnouncementScreen()
        self.enterSumScreen()
