...
class testGeneralReportApplicant(LiveServerTestCase):
    ...
    def enterApplicantScreen(self):
        
        appBtn = self.driver.find_element(by=By.ID,value='app_btn')
        appBtn.click()
    ...
    def testGeneralReportScholarship(self):

        self.logIn()
        self.enterReportScreen()
        self.enterApplicantScreen()
        self.enterSumScreen()
