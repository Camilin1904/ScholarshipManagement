...
class Migration(migrations.Migration):
    ...
    def insert_default_values(apps, schema_editor):
        ...
        eventsValues = [
            ...
            [1, '2023-11-05', '2023-11-09', 'Interview'],
            [1, '2023-11-10', '2023-11-14', 'Selection'],
            [1, '2023-11-15', '2023-11-19', 'Publication'],
            [2, '2023-11-20', '2023-11-28', 'Inscription'],
            [2, '2023-11-29', '2023-12-01', 'Interview'],
            [2, '2023-12-03', '2023-12-04', 'Selection'],
            [2, '2023-12-05', '2023-12-08', 'Publication'],
            [3, '2023-11-20', '2023-11-28', 'Inscription'],
            [3, '2023-11-29', '2023-12-01', 'Interview'],
            [3, '2023-12-03', '2023-12-04', 'Selection'],
            [3, '2023-12-05', '2023-12-08', 'Publication'],
            [4, '2023-12-10', '2023-12-11', 'Inscription'],
            [4, '2023-12-12', '2023-12-14', 'Interview'],
            [4, '2023-12-16', '2023-12-17', 'Selection'],
            [4, '2023-12-18', '2023-12-20', 'Publication'],
            [5, '2023-12-21', '2023-12-22', 'Inscription'],
            [5, '2023-12-23', '2023-12-24', 'Interview'],
            [5, '2023-12-26', '2023-12-27', 'Selection'],
            [5, '2023-12-29', '2023-12-31', 'Publication']
        ]
