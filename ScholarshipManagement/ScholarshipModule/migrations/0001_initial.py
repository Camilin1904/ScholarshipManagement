# Generated by Django 4.2.5 on 2023-11-11 20:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.IntegerField(choices=[(0, 'En revisión'), (1, 'Beneficiario'), (2, 'No aceptado'), (3, 'NA')], default=3)),
                ('image', models.ImageField(blank=True, default='', null=True, upload_to='images/photos')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('scholarship', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='id_Scholarship', to='ScholarshipModule.scholarships')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('applicant', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='id_applicant', to='ScholarshipModule.applicant')),
            ],
        ),
    ]
