...
class AnnouncementsStudents(models.Model):
    ...
    studentId = models.ForeignKey(
        Students, related_name = "StudentId2", blank = True, on_delete = models.CASCADE)
    announcementId = models.ForeignKey(
        Announcements, related_name = "AnnouncementId2", blank = True, null = True, on_delete = models.CASCADE)
